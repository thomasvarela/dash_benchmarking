translate_dict = {
    ...
    'type_crop_warning': {'en': 'You can only select one group of crops', 'es': 'Solo puedes seleccionar un grupo de cultivos', 'pt': 'Você só pode selecionar um grupo de culturas'},
